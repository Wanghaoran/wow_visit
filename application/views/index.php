...
<div class="contain">
    ...
    <div class="header">
        ...
        <div class="clear"></div>
        <div class="shipin">
            <embed src="http://player.youku.com/player.php/sid/XODAzNTkwMTQ0/v.swf" quality="high" width="493" height="323" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash"></embed>
        </div>
    ...
    <div class="xcbox">
        <div class="selectbox">
            <select class="select_area"><option></option><option>请选择</option></select>
            ...
            <div class="album-carousel" id="album-carousel">
                ...
                <div class="album-carousel-zone" id="album-carousel-zone">
                    <ul class="album-carousel-list" id="album-carousel-list">
                        ...
                        <!--下面li是保留一个空位置-->
                        <li class="album-carousel-thumb"></li>
                    </ul>
                </div>
    ...
    <!--jiangpin start-->
    <div class="jiangpin">
        <div class="jpbox"><img src="<?=$this->config->base_url()?>/static/images/img_jp1.png"/></div>
