...
class Welcome extends CI_Controller {
    ...
    public function recordpic(){
        ...
        //分享标题
        $title = urldecode('＃艾泽拉斯旅游局＃给鼎鼎有名的“地狱咆哮”选路线可一定不能马虎，我奋战了一夜终于选出一条应该可以让他恢复记忆的路线，不过谁也不能保证有效。小伙伴们，谁还有更适合“地狱咆哮”恢复记忆的路线？别吝啬了！艾泽拉斯就靠你了！http://v.youku.com/v_show/id_XODE5NjkwMzU2.html');
